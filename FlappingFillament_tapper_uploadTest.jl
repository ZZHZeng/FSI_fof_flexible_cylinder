...
# Geometry
AR = 20 # aspect ratio of cylinder #####
ARR = round(Int,AR)
...
# make a coupled sim
sim = CoupledSimulation((256,48,48),(U,0,0),L,body,struc,IQNCoupling;
...
name = "ExpU$(uu)_L$(LL)_Gpnts$(numE)_thk2$(thkk2)_AR$(ARR)_PinnedFree_RealCase_111"*tl
