...
function circle(;L=2^6,Re=250,U=1,mem=Array,T=Float32,thk=2)
    ...
    Body = ParametricBody(NurbsCurve(cps,knots,weights);thk=(u)->thk,boundary=false)
...
t₀,duration,tstep = round(sim_time(sim)), 0.1, 0.1
